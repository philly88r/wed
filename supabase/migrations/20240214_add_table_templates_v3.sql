...
-- First, drop the foreign key constraint from table_instances
ALTER TABLE table_instances 
DROP CONSTRAINT IF EXISTS table_instances_template_id_fkey;
...
ALTER TABLE table_instances
ADD CONSTRAINT table_instances_template_id_fkey 
FOREIGN KEY (template_id) 
REFERENCES table_templates(id);
